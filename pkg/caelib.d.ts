 ...
 */
export function start_with_params(rule: number, width: number, height: number, initial_state?: string | null): Promise<void>;
...
export interface InitOutput {
  ...
  readonly closure1171_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure520_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure522_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h83a3ad27906d3133: (a: number, b: number) => void;
  readonly closure3017_externref_shim: (a: number, b: number, c: any, d: any) => void;
