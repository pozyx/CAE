...
// Uses single buffer: reads from row N, writes to row N+1 (safe without race conditions)

@group(0) @binding(0) var<storage, read_write> ca_state: array<u32>;
...
// Get cell value at position in current row from CA buffer
