...
fn compute_tile(
    ...
    log_info!("Computing tile ({}, {}): cells {}..{}, generations {}..{}",
...
pub fn run_ca_with_cache(
    ...
    // Extract tile_size BEFORE any cache borrows to avoid borrow conflicts
    ...
    log_info!("Viewport needs tiles: X={}..{}, Y={}..{}",
    ...
    log_info!("Output buffer: width={}, height={}, padding={}",
